    ...
    public partial class BucketListData : BaseBucketListData, IBucketListData
    {
        ...
        public void DeleteTestUser(string userName)
        {
            ...
            try
            {
                ...
                cmd.CommandText = BucketListSql.DELETE_TEST_USER;
        ...
        public void LogBrowserCapability(int browserLogId, string key, string val)
        {
            SqlConnection conn = null;
            SqlCommand cmd = null;
            ...
            try
            {
                ...
                cmd = new SqlCommand();
                cmd.Connection = conn;
                cmd.CommandText = BucketListSql.LOG_BROWSER_CAPABIILITY;
                cmd.CommandType = System.Data.CommandType.Text;

                cmd.Parameters.Add(new SqlParameter("@BrowserLogId", browserLogId));
                cmd.Parameters.Add(new SqlParameter("@Key", key));
                cmd.Parameters.Add(new SqlParameter("@Value", val));
